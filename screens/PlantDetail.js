...
const PlantDetail = ({navigation}) => {
  ...
  const renderRequirementBar = () => (
    <View
      ...
      <RequirementBar icon={icons.seed} barPercentage="65%" />
    </View>
  );
  ...
  const renderRequirement = () => (
    <View
      ...
      <RequirementDetail icon={icons.sun} label="Sunlight" detail="18°C" />
      <RequirementDetail
        icon={icons.drop}
        label="Water"
        detail="250 ml Daily"
      ...
      <RequirementDetail icon={icons.seed} label="Fertilize" detail="150 mg" />
    </View>
  );
